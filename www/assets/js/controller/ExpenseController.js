/*Angular App,Cordova */
app.controller('ExpenseController', function($rootScope, $scope, $log, $ionicActionSheet, onlineStoreData, onlineStorePopup,
                         onlineStorePouchdb){
 ...
 function getExpenseList(){
        ...
        function (response) {
            ...
            angular.forEach(response.rows,function(event, index){
                ...
                var item =event.doc.expenseslist;
                $scope.expenses.push(item);
                 $log.info("expenseslist", $scope.expenses);
                }
    ...
    $scope.getExpenseName = function(expense){

        $scope.data.name = expense.expenseType;
