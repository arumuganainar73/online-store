/*Angular App,Cordova */
app.controller('PurchasereturnController', function($rootScope, $ionicActionSheet, $scope, $log, onlineStoreData, onlineStorePopup, 
                onlineStorePouchdb){
     ...
     *  @returns {Boolean}
     */
    $scope.addPurchaseReturn = function () {
        ...
        var purchasereturnObj = {
                ...
                'paidamount': $scope.data.paidamount,
                'description': $scope.data.description,
                'picture':$scope.data.file
                          
        }
        $log.info(purchasereturnObj);
        var data = {
           _id: new Date().toISOString(),
            purchasereturn: purchasereturnObj
    ...
    $scope.resetPurchaseReturn = function(){
        $scope.data = '';
    }
