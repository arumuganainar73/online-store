/*Angular App,Cordova */
app.controller('PurchaseController', function($rootScope, $ionicActionSheet, $scope, $log, onlineStoreData, onlineStorePopup, 
                onlineStorePouchdb){
