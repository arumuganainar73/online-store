/*Angular App,Cordova */
app.controller('CashinController', function($rootScope, $ionicActionSheet, $scope, $log, onlineStoreData, onlineStorePopup,
                         onlineStorePouchdb, toastr){
